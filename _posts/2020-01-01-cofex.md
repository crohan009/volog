...
where, 
 ...
 - $$h_{\theta}{(x_{1:t-1})}^T$$ is the **context representation** (created by a probabilistic model such a deep neural network architecture which is parameterized by $$\theta$$)
...
{: style="width: 150%;" class="center"}
*Fig. 8. Illustration of the CoFEx architecture performing code Language Modelling (LM) with features extracted from code sequences and its AST.*
